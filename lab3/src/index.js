...
//         vColor = vec4(ambient + diffuse,1.0);
...
//         gl.uniform3fv(gl.getUniformLocation(shaderProgram,"uLightPos"),lightPosition);
...
//             gl.uniform3fv(gl.getUniformLocation(shaderProgram,"uViewPos"),cameraPosition);
//         }
...
// //     switch(event.key){
// //         case "w":
// //             cameraPosition = cameraPosition.map((v,i)=>v+forward[i]*moveSpeed); break;
// //         case "s":
// //             cameraPosition = cameraPosition.map((v,i)=>v-forward[i]*moveSpeed); break;
// //         case "a":
// //             cameraPosition[0]-=right[0]*moveSpeed; cameraPosition[2]-=right[2]*moveSpeed; break;
// //         case "d":
// //             cameraPosition[0]+=right[0]*moveSpeed; cameraPosition[2]+=right[2]*moveSpeed; break;
...
//     switch(event.key){
//         case "w":
//             cameraPosition = cameraPosition.map((v,i)=>v+forward[i]*moveSpeed); 
//             break;
...
//         case "ArrowUp":
//             ambientStrength = Math.min(ambientStrength+0.05,1);
//             console.log("Ambient:", ambientStrength);
//             break;

//         case "ArrowDown":
//             ambientStrength = Math.max(ambientStrength-0.05,0);
//             console.log("Ambient:", ambientStrength);
//             break;
...
//             console.log("Linear attenuation:", linearAttenuation);
//             break;

//         case "x":
//             linearAttenuation = Math.max(0, linearAttenuation-0.01);
//             console.log("Linear attenuation:", linearAttenuation);
//             break;
...
//             console.log("Quadratic attenuation:", quadraticAttenuation);
//             break;

//         case "v":
//             quadraticAttenuation = Math.max(0, quadraticAttenuation-0.01);
//             console.log("Quadratic attenuation:", quadraticAttenuation);
//             break;
//     }
// }
